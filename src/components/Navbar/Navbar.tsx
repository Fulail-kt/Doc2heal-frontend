  ...
  return (
    <nav className="sm:w-40 text-gray-300">
      <div className='relative'>
        ...
        {navLinks.map((link) => (
  <li key={link.path} className={`p-2 rounded-md w-full ${link.path === "/profile" ? '' : 'mb-7'} hover:text-[#ffff] bg-[#538deb]`}>
      ...
      <span className="md:hidden p-1 px-2">
        ...
        {link.display === 'Profile' && <FontAwesomeIcon icon={faUser} style={{ color: "#ffffff" }} />}
          ...
          {location.pathname === '/profile' && (
            <li className="p-2 rounded-md w-full mt-7 hover:text-[#ffff] bg-[#538deb]">
