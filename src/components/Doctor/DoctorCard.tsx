      ...
      <Link to={`/doctors/${_id}`}>
        ...
        <div className='mt-[10px]  flex items-center justify-between'>
          <div className='flex justify-center flex-col w-full'>
            <h3 className=' text-[10px]  leading-4 sm:text-[14px] md:text-[18px] lg:text-[18px]  font-normal text-slate-800'>3+patients</h3>
            <p className='text-[10px] sm:text-[14px] md:text-[18px] leading-6 font-[400] text-slate-700 '>{hospital}</p>
          </div>
        </div>
      </Link>
    </div>
